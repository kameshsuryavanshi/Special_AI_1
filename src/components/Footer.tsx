...
//               <HiLocationMarker className="text-yellow-400 mt-1 w-5 h-5 flex-shrink-0" />
//               <div>
...
//               <MdEmail className="text-yellow-400 w-5 h-5 flex-shrink-0" />
//               <a
...
//               <button
//                 type="submit"
//                 className="px-4 py-2 bg-[#EBB35C] text-white font-semibold rounded-r"
//               >
//                 Subscribe
//               </button>
//             </form>
