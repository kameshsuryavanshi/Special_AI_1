  ...
  return (
    <section id="solutions" className="section-scroll py-14 lg:py-22 bg-gradient-to-br from-white to-gray-50 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {[
            { name: "Diagnostic Assessment", desc: "Conduct initial baseline assessments to identify student strengths and needs.", icon: "🔍", color: "from-blue-500 to-indigo-500" },
            { name: "IEP Goals & Objectives", desc: "Generate SMART goals and measurable objectives tailored to each student.", icon: "🎯", color: "from-indigo-500 to-blue-600" },
            { name: "Lesson Planning", desc: "Create customized instructional plans aligned with IEP goals.", icon: "📚", color: "from-blue-600 to-purple-500" },
            { name: "Session Tracking", desc: "Log sessions and behavioral data for ongoing monitoring.", icon: "📋", color: "from-purple-500 to-blue-500" },
            { name: "Progress Review", desc: "Assess goal advancement with automated analytics and visualizations.", icon: "📈", color: "from-blue-500 to-indigo-600" },
            { name: "Compliance Reports", desc: "Generate IDEA-compliant documentation for accountability.", icon: "✅", color: "from-indigo-600 to-blue-500" },
          ].map((tool, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 50 }}
